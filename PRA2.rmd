...
```{r}
titanic_data <-read.csv("./train_titanic.csv",header=T,sep=",")
```

Calcularemos ahora las dimensiones del conjunto:

```{r}
dim(data)
```

Observamos que el conjunto analizado se compone de 891 registros y 12 variables.
