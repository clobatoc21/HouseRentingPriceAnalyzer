...
1. ¿Cómo se relacionan la clase, el género y la edad con la tasa de suprervivencia?
...
Como primer paso, antes de comenzar la limpieza, realizamos la carga del conjunto a estudiar:

```{r}
  titanic_data <-read.csv("./train_titanic.csv", header=T, sep=",", fileEncoding = "UTF-8", na.strings=c("NA", ""))
```
...
- Cabin: Nos faltan 687 datos de los 891 registros (77,1%). Eliminaremos la variable de nuestro conjunto, pues no aporta información para las preguntas planteadas y faltan demasiados datos.
